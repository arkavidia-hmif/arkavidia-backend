...
class EventCheckInTestCase(APITestCase):
    ...
    def test_checkin_get(self):
        ...
        self.assertEqual(checkin_data['attendee']['name'], self.attendance_unattended.attendee.name)
        self.assertEqual(checkin_data['attendee']['email'], self.attendance_unattended.attendee.email)
        self.assertEqual(checkin_data['pax'], self.attendance_unattended.pax)
        self.assertEqual(checkin_data['event']['name'], self.attendance_unattended.event.name)
